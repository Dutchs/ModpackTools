...
public class EntityLayer implements LayeredDraw.Layer {
    @Nullable
    ...
    public void render(@NotNull GuiGraphics guiGraphics, @NotNull DeltaTracker deltaTracker) {
        if(HUDManager.RENDERENTITY){
            ...
            if(integratedServer != null){
                ...
                RenderUtil.drawEntityOverlay(guiGraphics, entityInfo, entityCount, dimensionID, overlayWidth, overlayHeight);
            } else {
                HUDManager.clearHUD();
            }
        }
