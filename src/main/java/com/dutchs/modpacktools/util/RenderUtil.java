...
//        font.draw(pGraphics, String.format("Entities: %d - %s", entityCount, dimensionID), 2f, 2F, -1);
    ...
    public static void drawTPSOverlay(@NotNull GuiGraphics guiGraphics) {
...
//        pGuiGraphics.drawString(font, s, hudLeft + j1 - font.width(s), hudBottom - 60 - 9, 14737632);
    ...
    public static void drawFPSOverlay(@NotNull GuiGraphics guiGraphics) {
//        Minecraft minecraft = Minecraft.getInstance();
//        Font font = minecraft.font;
...
//        }
//
//        guiGraphics.fill(RenderType.guiOverlay(), hudLeft, hudBottom - 60, hudLeft + j1, hudBottom, -1873784752);
//
//        while($$8 != j) {
...
//            int sampleColor = getSampleColor(Mth.clamp(scaled, 0, l2), 0, l2 / 2, l2);
//            int clamped = Mth.clamp(scaled, 0, hudHeight + 5);
//            guiGraphics.fill(RenderType.guiOverlay(), l, hudBottom - clamped, l + 1, hudBottom, sampleColor);
//            ++l;
//            $$8 = frameTimer.wrapIndex($$8 + 1);
//        }
//
//        guiGraphics.fill(RenderType.guiOverlay(), hudLeft + 1, hudBottom - 30 + 1, hudLeft + 14, hudBottom - 30 + 10, -1873784752);
//        guiGraphics.drawString(font, "60 FPS", hudLeft + 2, hudBottom - 30 + 2, 14737632, true);
//        guiGraphics.hLine(RenderType.guiOverlay(), hudLeft, hudLeft + j1 - 1, hudBottom - 30, -1);
//        guiGraphics.fill(RenderType.guiOverlay(), hudLeft + 1, hudBottom - 60 + 1, hudLeft + 14, hudBottom - 60 + 10, -1873784752);
//        guiGraphics.drawString(font, "30 FPS", hudLeft + 2, hudBottom - 60 + 2, 14737632, true);
//        guiGraphics.hLine(RenderType.guiOverlay(), hudLeft, hudLeft + j1 - 1, hudBottom - 60, -1);
//
//        guiGraphics.hLine(RenderType.guiOverlay(), hudLeft, hudLeft + j1 - 1, hudBottom - 1, -1);
//        guiGraphics.vLine(RenderType.guiOverlay(), hudLeft, hudBottom - 60, hudBottom, -1);
//        guiGraphics.vLine(RenderType.guiOverlay(), hudLeft + j1 - 1, hudBottom - 60, hudBottom, -1);
//        int l3 = (Integer)minecraft.options.framerateLimit().get();
//        if (l3 > 0 && l3 <= 250) {
//            guiGraphics.hLine(RenderType.guiOverlay(), hudLeft, hudLeft + j1 - 1, hudBottom - 1 - (int)((double)1800.0F / (double)l3), -16711681);
//        }
//
//        String s1 = min + " ms min";
//        String s2 = total / (long)j1 + " ms avg";
//        String s = max + " ms max";
//        guiGraphics.drawString(font, s1, hudLeft + 2, hudBottom - 60 - 9, 14737632);
//        guiGraphics.drawCenteredString(font, s2, hudLeft + j1 / 2, hudBottom - 60 - 9, 14737632);
//        guiGraphics.drawString(font, s, hudLeft + j1 - font.width(s), hudBottom - 60 - 9, 14737632);
    }
}
