...
public class ModpackTools {
    ...
    public static void logError(String s, Exception exception) {
        LOGGER.error(s, exception);
    }

    public ModpackTools() {
        LOGGER.info(Constants.MODNAME + " Constructing");
        ...
        ContainerRegistry.MENU_TYPES.register(FMLJavaModLoadingContext.get().getModEventBus());
