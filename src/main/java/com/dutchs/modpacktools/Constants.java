...
public class Constants {
    ...
    public static final ChatFormatting SUGGEST_COMMAND_FORMAT = ChatFormatting.DARK_GREEN;
    public static final ChatFormatting RUN_COMMAND_FORMAT = ChatFormatting.DARK_RED;
